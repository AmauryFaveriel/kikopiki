import main0 from './assets/imgs/paintings/0/main.jpeg';
...
const data = {
    intro: {
        title: 'Kikopiki',
        intro_1: 'Rien ne se perd, rien ne se crée tout se transforme, disait Lavoisier à propos de la matière. Parait-il que dans l\'histoire de la peinture, c\'est un peu la même chose.',
    ...
    paintings: [
        ...
        },
        {
            ...
            intro: 'DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO DEFAULT_INTRO',
            main_painting: {
                author: 'Rembrandt',
        ...
        },
        {
            ...
            other_paintings: [
                {
                    desc: '« Qu’est-ce au fond qu’un peintre ? C’est un collectionneur qui veut se constituer une collection en faisant lui-même les tableaux qu’il aime chez les autres. C’est comme cela que je commence et puis cela devient autre chose. » Pablo Picasso',
                    visual: other2_0,
                },
                {
        ...
        },
        {
            ...
            zooms: [
                ...
                {
                    desc: 'Fernando Botero fait partie de ses peintres contemporain qui se réapproprie des oeuvres de peintre classique. C’est le cas de cette oeuvre nommé D’après Velasquez Infante Marguerite Thérèse en bleu. En effet cette peinture s’inspire d’une oeuvre du grand maître Espagnol, Diego Velázquez, qui fût le peintre du roi Philippe IV. ',
                    zoom: {
                        main: {
                            scale: 1.5,
                            x: 10,
            ...
            other_paintings: [
                {
                    desc: 'Le style singulier de Botero lui a été inspiré en partie par les fresques Egytiennes, il a déclaré un jour : « Je peins aussi des visages impassibles, sans psychologie, car je veux donner un sentiment d\'éternité, comme dans les fresques égyptiennes. » ',
                    visual: other3_0,
                },
                {
                    desc: 'La racine même du style de Botero, avec ses personnages volumétriques, tout en rondeur lui est venu en observant l\'art précolombien. Le peintre Colombien s\'est lui même surnommé ironiquement « Le plus Colombien des artistes Colombiens ».',
                    visual: other3_1,
                },
                {
                ...
                {
                    desc: 'Fernando Botero veut prendre le contre pied et retrouver le volume que la peinture contemporaine a complètement oublié. C\'est ainsi qu\'il s\'est intéressé à l\'histoire de l\'art, au trecento et au quattrocento. « En Toscane, j\'ai été marqué par Giotto qui le premier a donné l\'illusion du volume dans ses fresques. C\'était une vraie révolution. Il faut regarder les grands maîtres pour apprendre » a dit Fernando Botero',
                    visual: other3_3,
                }
            ],
        },
