...
const data = {
  intro: {
    title: "Kikopiki",
    intro_1:
      "Rien ne se perd, rien ne se crée tout se transforme, disait Lavoisier à propos de la matière. Paraît-il que dans l'histoire de la peinture, c'est un peu la même chose.",
    intro_2:
  ...
  paintings: [
    ...
    },
    {
      ...
      other_paintings: [
        {
          desc:
          "Mais en y regardant de plus près, cette peinture de Botero recèle de nombreuses différences. En effet, l\’oeuvre de Botero est en réalité un mélange subtile de plusieurs oeuvres de Velasquez. Véritable hommage au travail de Velasquez, que le peintre Colombien admire et s’en est inspiré à plusieurs reprises. Botero a reprit des éléments : le mouchoir et la fleur tenu par l\’infante, qui sont présents dans un notre portrait de la princesse : L\’Infante Marguerite-Thérèse en robe rose, également réalisé par le maître Espagnol. ",
          visual: other3_0
        },
        {
          desc:
          "Un autre élément a été ajouté par Botero, il s\’agit du miroir. Ce dernier est issu d\’un autre tableau célèbre tableau de Velazquez : Les ménines. Cet ajout du miroir dans l\’oeuvre de Botero introduit un élément d’intrigue, déjà présente dans cette célèbre peinture de Velazquez. ",
          visual: other3_1
        },
        {
          desc:
        ...
        },
        {
          ...
          visual: other3_3 /* changer image : ArtPreColombien */
        },
        {
          desc:
